...
var LocationPage = /** @class */ (function () {
    function LocationPage(authService, apiService, locationService, router, loadingCtrl, _translate, toastService) {
    ...
    LocationPage.prototype.ionViewDidEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.loadMap().then(function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.map.getMyLocation().then(function (location) {
                                ...
                                var myLocation = _this.map.getCameraTarget();
                                setTimeout(function () {
                                    _this.lat = myLocation.lat;
                                    _this.lng = myLocation.lng;
                                    console.log(_this.lat);
                                    console.log(_this.lng);
                                }, 800);
                            })];
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.map
                                ...
                                _this.toastService.simpleToast(_this._translate.instant('general.enable_location_from_settings_first'), 'danger', 2000);
                            })];
                    case 3:
                        // Get the location of you
                        _b.sent();
                        return [4 /*yield*/, this.locationService.getMyLocation()];
                    case 4:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    LocationPage.prototype.updateLocation = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, this.locationService.getMyLocation().then(function () {
                                _this.apiService
                                    .updateLocation(_this.authService.userToken, _this.locationService.myLat, _this.locationService.myLng)
                                    .subscribe(function (res) {
                                    console.log(res);
                                    _this.loading.dismiss();
                                    if (res.success === 'ok') {
                                        _this.toastService.simpleToast(_this._translate.instant('general.update_location_success'), 'success', 2000);
                                    }
                                }, function (error) {
                                    console.log(error);
                                    _this.loading.dismiss();
                                    _this.toastService.simpleToast(_this._translate.instant('general.update_location_faild'), 'danger', 2500);
                                });
                            })];
                    case 3:
                        _b.sent();
