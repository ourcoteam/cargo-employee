...
let ShipmentDetailsPageModule = class ShipmentDetailsPageModule {
};
...
let ShipmentDetailsPage = class ShipmentDetailsPage {
    constructor(backgroundGeolocation, geolocation) {
    ...
    loadMap() {
        ...
        this.map.on(_ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_4__["GoogleMapsEvent"].MAP_READY).subscribe(e => {
            let option = {
                position: {
                    lat: this.lat,
                    lng: this.long
    ...
    initializeBackgroundPosition() {
        ...
        this.backgroundGeolocation.configure(config)
            .then(() => {
            this.backgroundGeolocation.on(_ionic_native_background_geolocation_ngx__WEBPACK_IMPORTED_MODULE_2__["BackgroundGeolocationEvents"].location).subscribe((location) => {
...
ShipmentDetailsPage.ctorParameters = () => [
...
//# sourceMappingURL=shipment-details-shipment-details-module-es2015.js.map