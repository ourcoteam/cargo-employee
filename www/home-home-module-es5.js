...
var HomePage = /** @class */ (function () {
    function HomePage(barcodeScanner, audio, authService, apiService, platform, modalController, router, toastController, _translate, loadingUI, zone) {
        ...
        this.router.events
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_8__["NavigationStart"]; }))
    ...
    HomePage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.authService.ifLoggedIn().then(function () {
                    ...
                    _this.authService.authState.subscribe(function (state) {
                        if (state &&
                            ...
                            _this.authService.userToken) {
                            _this.updateWalletNoti();
                        }
                    });
                });
                return [2 /*return*/];
    ...
    HomePage.prototype.updateWalletNoti = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    HomePage.prototype.presentToast = function (msg, pos, col, dur) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    HomePage.prototype.scanCode = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.barcodeScanner
                            .scan()
                            .then(function (barcodeData) {
                            // console.log(barcodeData);
                            if (!barcodeData.cancelled) {
                                console.log('barcodeData', barcodeData);
                                _this.audio.play('codeScanned');
                                _this.trackingID = barcodeData.text;
                                _this.loadingUI.simpleLoading();
                                // this.apiService.getShipmentDetails('REF702380').subscribe(
                                _this.apiService.getShipmentDetails(_this.trackingID).subscribe(function (shipmentData) {
                                    console.log(shipmentData);
                                    _this.trackScanned = true;
                                    _this.currentTap = 'search';
                                    // console.log(this.currentTap);
                                    _this.loadingUI.loadingDismiss();
                                    _this.searched = [shipmentData];
                                    // console.log(this.searched);
                                    _this.modalController.create({
                                        ...
                                        componentProps: {
                                            data: shipmentData,
                                            shipment_id: shipmentData.number,
                                            userToken: _this.authService.userToken
                                        },
                                    }).then(function (m) { return m.present(); });
                                }, function (error) {
                                    _this.loadingUI.loadingDismiss();
                                    // console.log(error);
                                    // console.log('nothing found');
                                    _this.presentToast(_this._translate.instant('general.No_shipments_found'), 'bottom', 'danger', 3000);
                                });
                            }
    ...
    HomePage.prototype.trackOrder = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.apiService.getShipmentDetails(this.trackingID).subscribe(function (shipmentData) {
                                console.log(shipmentData);
                                _this.trackScanned = true;
                                _this.currentTap = 'search';
                                _this.loadingUI.loadingDismiss();
    ...
    HomePage.prototype.trackingChange = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    HomePage.prototype.clearTracking = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.trackingID = '';
                this.searched = [];
    ...
    HomePage.prototype.getUserShipments = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authService.getUserData()];
                    case 1:
                        _a.sent();
                        ...
                        return [4 /*yield*/, this.apiService
                                ...
                                // );
                                _this.totalCurrent = shipments.count;
                                _this.userShipments = shipments;
    ...
    HomePage.prototype.shipmentDetail = function (shipmentID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, modal.present().then(function () {
                                modal.onWillDismiss().then(function () {
                                    ...
                                    _this.trackingID = '';
                                    _this.scannedData = {};
                                    _this.trackScanned = false;
                                    _this.searched = [];
                                    _this.currentTap = 'current';
                                });
                            })];
    ...
    HomePage.prototype.navigate = function (lat, lng, locName) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
    ...
    HomePage.prototype.loadMore = function (event, type) {
        var _this = this;
        if (type === 'current') {
            if (this.totalCurrent > this.userShipments.length) {
                ...
                this.apiService
                    ...
                    var _a;
                    console.log(data);
                    (_a = _this.userShipments).push.apply(_a, data.items);
                    setTimeout(function () {
    ...
    HomePage.prototype.reload = function (event, type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (type === 'current') {
                    this.currPageNum = 1;
