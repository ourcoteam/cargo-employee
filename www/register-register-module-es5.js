...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(platform, loadingCtrl, toastCtrl, apiService, formBuilder, navCtrl, authService, _translate) {
    ...
    RegisterPage.prototype.getCountries = function () {
        var _this = this;
        this.apiService.getCountries().subscribe(function (countries) {
            _this.countries = countries;
        });
    };
    RegisterPage.prototype.getRegions = function () {
        var _this = this;
        this.apiService
    ...
    RegisterPage.prototype.getAreas = function () {
        var _this = this;
        this.apiService
    ...
    RegisterPage.prototype.searchForName = function (itemID, arrayItems) {
        var res = arrayItems.filter(function (item) { return item.id === itemID; });
        // console.log(res);
        return res[0].name;
    };
                ...
                if (this.lat && this.lng) {
                    ...
                    this.apiService.registerClient(registerData).subscribe(function (userData) {
                        if (userData && userData.token && userData.user) {
                            _this.authService.doLogin(userData);
                            _this.toNextStep();
                            _this.showToast(_this._translate.instant('general_account_created_successfully'), 2000, 'bottom', 'success');
                            setTimeout(function () {
                        ...
                        if (error.statusText === 'Unauthorized') {
                            _this.step = 1;
                            _this.progress = _this.step / 4;
                            _this.slides.lockSwipes(false);
                            _this.slides.slideTo(0);
                            _this.slides.lockSwipes(true);
                            _this.userInfoForm.controls.email.setErrors({ incorrect: true });
                            _this.inputEmail.setFocus();
                        }
                        _this.showToast(error.error.error, 3000, 'bottom', 'danger');
                    });
                }
                break;
        }
    };
    RegisterPage.prototype.toNextStep = function () {
    ...
    RegisterPage.prototype.getAddressCenter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var addressArray, addressText, _a;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        addressText = addressArray.city + " " + addressArray.region + " " + addressArray.country;
                        _a = this;
                    ...
                    case 2:
                        ...
                        _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_3__["Geocoder"].geocode({
                            ...
                            if (results.length > 0) {
                                ...
                                _this.lat = results[0].position.lat;
                                _this.lng = results[0].position.lng;
                                // console.log(this.lat);
                                // console.log(this.lng);
                            }
                            else {
    ...
    RegisterPage.prototype.getCurrentLocation = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
    ...
    RegisterPage.prototype.showToast = function (msg, time, place, theme) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
