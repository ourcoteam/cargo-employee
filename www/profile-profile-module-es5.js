...
var ProfilePage = /** @class */ (function () {
    function ProfilePage(authService, apiService, router, _translate, loadingUI) {
        var _this = this;
    ...
    ProfilePage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authService.returnUserLang().then(function (lang) {
                            // console.log(lang);
                            _this.userLang = lang;
    ...
    ProfilePage.prototype.changeLang = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                console.log(this.userLang);
                this.authService.changeUserLang(this.userLang).then(function () {
                    console.log(_this.authService.userData.language);
                });
                return [2 /*return*/];
            });
        });
